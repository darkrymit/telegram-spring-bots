...
public class CallbackQueryArgumentResolver implements HandlerMethodArgumentResolver {

  @Override
  public boolean supportsParameter(MethodParameter parameter) {
    return CallbackQuery.class.isAssignableFrom(parameter.getParameterType());
  }

  @Override
  @Nullable
  public CallbackQuery resolveArgument(MethodParameter parameter, TelegramRequest request,
      ModelAndViewContainer container, TelegramDataBinderFactory binderFactory) throws Exception {
    return request.getUpdate().callbackQuery();
  }
}
