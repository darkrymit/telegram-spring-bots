...
public class ChatJoinRequestArgumentResolver implements HandlerMethodArgumentResolver {

  @Override
  public boolean supportsParameter(MethodParameter parameter) {
    return ChatJoinRequest.class.isAssignableFrom(parameter.getParameterType());
  }

  @Override
  @Nullable
  public ChatJoinRequest resolveArgument(MethodParameter parameter, TelegramRequest request,
      ModelAndViewContainer container, TelegramDataBinderFactory binderFactory) throws Exception {
    return request.getUpdate().chatJoinRequest();
  }
}
